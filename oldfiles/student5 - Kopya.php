...
<a href="<?php echo $base_link; ?>&page=1"><<</a> <!-- İlk Sayfa -->

<?php if($current_page > 1): ?>
<a href="<?php echo $base_link; ?>&page=<?php echo ($current_page - 1); ?>"><</a> <!-- Önceki Sayfa -->
<?php endif; ?>
...
for($i = max(1, $current_page - 3); $i <= min($total_pages, $current_page + 3); $i++): ?>
    <a href="<?php echo $base_link; ?>&page=<?php echo $i; ?>" <?php echo ($i == $current_page) ? 'style="font-weight: bold;"' : ''; ?>><?php echo $i; ?></a>
<?php endfor; ?>

<?php if($current_page < $total_pages): ?>
<a href="<?php echo $base_link; ?>&page=<?php echo ($current_page + 1); ?>">></a> <!-- Sonraki Sayfa -->
<?php endif; ?>

<a href="<?php echo $base_link; ?>&page=<?php echo $total_pages; ?>">>></a> <!-- Son Sayfa -->